...
class PageModel extends BaseModel
{
  ...
  public function update_by_title($item_id, $page_title, $page_content, $cat_name = '', $s_number = 99, $author_uid = 0,
                                  $author_username = 'update_by_title', $oo_page_id = null)
  {
    ...
    if ($page_content) {
      if ($oo_page_id) {
        $page_array = D("Page")->field("page_id")->where(" item_id = '$item_id' and is_del = 0  and page_id = '$oo_page_id'")->find();
      } else {
